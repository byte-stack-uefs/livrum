...
const UserManagment = () => {
    ...
    return (
        <>
            ...
            <Typography
                sx={{fontSize: 32, color: theme.palette.darker.main, alignItems: 'center', marginTop: '1%', display: 'flex', textTransform: 'uppercase'}}
                variant="h1" className={sourceSans3.className}>
                Usuários
            </Typography>
            <Box
                sx={{
            ...
            >
                <Tabs value={value} scrollButtons={false} onChange={handleChange} centered style={{margin: '-10px'}}
